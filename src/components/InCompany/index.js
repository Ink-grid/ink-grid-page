  ...
  return (
    <div className="in-company">
      ...
      <div className="objetivos">
        ...
        <h2>OBJETIVO</h2>
        <p>
          Integrar una oferta de formación Empresarial y entrenamiento integral,
          con rigor en la actualización de temas, con aplicaciones de casos de
          usos especializados según demanda en contextos muy ajustados y con un
          alto valor añadido digital.
        </p>
        </div>
      </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h3>GESTIÓN DEL CONOCIMIENTO, LIDERAZGO Y CUADRO DE MANDO EN LA DIRECCIÓN DEL TALENTO HUMANO</h3>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
